...
public class TreeMapExample {
	public static void main(String[] args) {
		...
		map.put("Red", "Carpet");
		System.out.println("Map elements:"+map); //elements ordered by ascending(by key)
		...
		//map.put(null, "NullTest"); // allows null value only as a first element but throws exception 
													//if we enter after first
	}
