...
class PalindromicPermutationsOfString {

	static int MAX_CHAR = 26;

//Function to count frequency of each char in the string. 
...
//Function for odd freq char and reducing its freq by 1, returns garbage value if odd freq char is not present 
